...
function confirmCancel() {
    let result = window.confirm("Do you wish to return to your shopping cart ?");
    if (result) {
...
function confirmCheckout() {
    let result = window.confirm("Do you wish to checkout from your shopping cart ?");
    if (result) {
...
function confirmLogout() {
    let result = window.confirm("Do you wish  to logout of your shopping cart ?");
    if (result) {
...
function confirmRemove(title, movieID) {
    let result = window.confirm("Do you wish to remove the selected movie from your shopping cart ?");
    if (result) {
